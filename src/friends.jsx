    ...
    <div className="friends-widget">
        <div className="fw-header">
            ...
            <label className="fw-search" aria-label="Search friend">
                ...
                />
                <svg className="fw-search-icon" width="16" height="16" viewBox="0 0 24 24">
        ...
        <div className="fw-list" role="list">
            <div className="fw-loading">Loading...</div>
                <div className="fw-item" role="listitem">
                    <div className="fw-avatar"></div>
                    <div className="fw-meta">
                        <div className="fw-name"></div>
                    </div>
                    <div className="fw-level">lvl</div>
                </div>
